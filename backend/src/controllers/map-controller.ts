 ...
 * Get parsed map file
 */
export const getMapFile = (req: express.Request, res: express.Response): void => {
 ...
 * }
 */
export const createNewMapFile = (req: express.Request, res: express.Response): void => {
 ...
 * }
 */
export const addToMapFile = (req: express.Request, res: express.Response): void => {
  const fileName = req.params.map_file;
  const body = req.body.map;
 ...
 * }
 */
export const addToOrUpdateMapFile = (req: express.Request, res: express.Response): void => {
  const fileName = req.params.map_file;
  const body = req.body.map;
 ...
 */
export const removeMapFile = (req: express.Request, res: express.Response): void => {
  const fileName = req.params.map_file;
